...
# InitaliE API
class API:
    def __init__(self, model, test_dataset, output_path, prompt,api_key):
        self.model = model
...
if __name__ == "__main__":
    ...
    output_path = "Lllama3Test/llama_3.1_70b_versatile_KaranFontPrompt_WsmallFix.jsonl"
...
You are a top-tier algorithm designed for extracting information in structured formats to build a knowledge graph. 
                ...
                6.Coreference Resolution
                    ...
                    If an entity, such as "Tyrosine", is mentioned multiple times in the text but is referred to by different names or pronouns (e.g., "Tyr"), 
                ...
                output: [["Vanillin","Organoleptic effects","vanilla aroma"],["Vanillin","Routes of exposure","inhalation"]]
                END OF EXAMPLE
                Example:
    ...
    # Set up API
    client = API(model, test_dataset, output_path, prompt,api_key)
